...
class RSlider extends Component {
    ...
    initSlider() {
        //var RS1 =
        //     console.log("initSlider", this.props.set)
            ...
            onChange: function (vals) {
                this.props.onclick(this.props.statename, vals)
            }.bind(this)
        });
    }
    componentDidMount(){
        ...
        return (
            <div className="container">
                <div className="slider-container">
                    <input type="text" id={this.props.id} className="slider"/>
                </div>
            </div>
        )
    }
...
RS.prototype.createSlider = function () {
    ...
    // console.log('this.withoutselected', this.withoutselected)

    if (!this.withoutselected) this.selected = createElement('div', this.cls.selected);
    ...
    !this.withoutselected && this.slider.appendChild(this.selected);
...
RS.prototype.setInitialValues = function () {
    ...
    // console.log("setInitialValues", this.conf.set)
...
RS.prototype.createScale = function (resize) {
    this.step = this.sliderWidth / (this.conf.values.length - 1) - 1;
    // console.log('this.conf.values.length', this.conf.values.length)
...
RS.prototype.updateScale = function () {
    ...
    for (var i = 0, iLen = pieces.length; i < iLen; i++)
        pieces[i].style.width = i === (iLen - 1) ? 0 : this.step + 'px'; //this.step + 'px';
